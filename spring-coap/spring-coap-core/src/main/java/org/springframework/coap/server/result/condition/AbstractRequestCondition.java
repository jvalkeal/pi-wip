...
/**
 * A base class for {@link CoapRequestCondition} types providing implementations of
 ...
 */
public abstract class AbstractRequestCondition<T extends AbstractRequestCondition<T>> implements CoapRequestCondition<T> {
