 ...
 *
 */
@ConfigurationProperties("spring.cloud.stream.coap")
public class CoapExtendedBindingProperties implements ExtendedBindingProperties<CoapConsumerProperties, CoapProducerProperties> {

	private Map<String, CoapBindingProperties> bindings = new HashMap<>();

	public Map<String, CoapBindingProperties> getBindings() {
		return this.bindings;
	}

	public void setBindings(Map<String, CoapBindingProperties> bindings) {
	...
	public CoapConsumerProperties getExtendedConsumerProperties(String channelName) {
		if (this.bindings.containsKey(channelName) && this.bindings.get(channelName).getConsumer() != null) {
			...
			return new CoapConsumerProperties();
		}
	}
	...
	public CoapProducerProperties getExtendedProducerProperties(String channelName) {
		if (this.bindings.containsKey(channelName) && this.bindings.get(channelName).getProducer() != null) {
			...
			return new CoapProducerProperties();
		}
	}
}
