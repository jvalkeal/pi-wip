...
public class CoapRequestExecutingMessageHandlerTests extends AbstractCoapTests {
	...
	public void test() throws URISyntaxException {
		...
		CoapRequestExecutingMessageHandler handler = new CoapRequestExecutingMessageHandler(coapTemplate);
