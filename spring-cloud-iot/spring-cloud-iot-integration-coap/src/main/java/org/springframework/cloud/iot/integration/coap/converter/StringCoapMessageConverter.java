...
public class StringCoapMessageConverter extends AbstractCoapMessageConverter<String> {
	...
	@Override
	public String read(Class<? extends String> clazz, byte[] message) throws IOException {
		return new String(message, defaultCharset);
	}

	@Override
	public void write(String t, int contentFormat, byte[] message) throws IOException {
	}
