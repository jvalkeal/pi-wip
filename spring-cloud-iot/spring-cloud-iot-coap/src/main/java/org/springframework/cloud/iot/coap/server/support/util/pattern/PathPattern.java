...
import org.springframework.cloud.iot.coap.server.support.PathContainer.Element;
import org.springframework.cloud.iot.coap.server.support.PathContainer.Separator;
 ...
 * "spring" {@code ->} "/image.png", and {@code /resources/css/spring.css} will match
 * with "spring" {@code ->} "/css/spring.css"</li>
...
public class PathPattern implements Comparable<PathPattern> {
	 ...
	 *
	 * @param otherPattern the other pattern
	 * @return the int
	 */
	@Override
	 ...
	 *
	 * @param pattern2string the pattern 2 string
	...
	public static class PathMatchInfo {
		...
		/**
		 * Instantiates a new path match info.
		 *
		 * @param uriVars the uri vars
		 * @param matrixVars the matrix vars
		 */
	...
	public static class PathRemainingMatchInfo {
		...
		/**
		 * Instantiates a new path remaining match info.
		 *
		 * @param pathRemaining the path remaining
		 */
		 ...
		 *
		 * @param pathRemaining the path remaining
		 * @param pathMatchInfo the path match info
		 */
	...
	/**
	 * Checks if is catch all.
	 *
	 * @return true, if is catch all
	 */
	boolean isCatchAll() {
	...
	/**
	 * Gets the captured variable count.
	 *
	 * @return the captured variable count
	 */
	...
	class MatchingContext {
		...
		/** The remaining path index. */
		// points to the remaining path that wasn't consumed
		int remainingPathIndex;

		/**
		 * Instantiates a new matching context.
		 *
		 * @param pathContainer the path container
		 * @param extractVariables the extract variables
		 */
		...
		/**
		 * Sets the match allow extra path.
		 */
		...
		/**
		 * Checks if is match optional trailing separator.
		 *
